...
function ENT:PhysicsSimulate( phys, deltatime )
	...
	self.ShadowParams.pos = self.Entity:GetOwner():GetShootPos() + self.Entity:GetOwner():GetAimVector() * 5
	self.ShadowParams.angle = self.Entity:GetOwner():GetAimVector():Angle()
	self.ShadowParams.maxangular = 900000 
	self.ShadowParams.maxangulardamp = 999999
	self.ShadowParams.maxspeed = 900000 
	self.ShadowParams.maxspeeddamp = 999999
	self.ShadowParams.dampfactor = 0.5 
	self.ShadowParams.teleportdistance = 1000 
